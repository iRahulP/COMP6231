...
import java.rmi.registry.Registry;      import java.rmi.server.UnicastRemoteObject; //Used for exporting a remote object
...
public class RemotePrintServer extends UnicastRemoteObject implements RemotePrintInterface {
 ...
 // the actual implementation of the method specified by RemotePrintInterface
  ...
  public static final void main(final String args[]) {
    ...
    try {
      // create the (local) object registry - for storing and retrieving remote object references bound with arbitrary string names.
